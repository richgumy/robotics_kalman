...
var_poly_coeffs = [[0.8815, -0.3157, 0.0294],[0.2572, -0.0646, 0.0041],\
			[0.0175, -0.0067, 0.0007],[0.0014, -0.0020, 0.0011]]

sonar1_obj = Sensor(sonar1_min_max[0],sonar1_min_max[1],var_sonar[0],'Sonar',sonar1,0,0,[0, 0, 0.05]) #temporary constant var values for var_coeffs
